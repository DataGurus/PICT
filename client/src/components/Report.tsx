              ...
              <div className="output-section">
                ...
                <ul>
                  {reportData.treatment_recommendations &&
                    Object.entries(reportData.treatment_recommendations).map(([key, value], index) => (
                      <li key={index}>
              ...
              <div className="output-section">
                ...
                <ul>
                  {reportData.possible_cause &&
                    Object.entries(reportData.possible_cause).map(([key, value], index) => (
                      <li key={index}>
                        <strong>{key}:</strong> {value}
                      </li>
                    ))}
              ...
              <div className="output-section">
                ...
                <ul>
                  {reportData.blood_tests &&
                    Object.entries(reportData.blood_tests).map(([key, value], index) => (
                      <li key={index}>
                        <strong>{key}:</strong> {value}
                      </li>
                    ))}
              ...
              <div className="output-section">
                ...
                <ul>
                  {reportData.prescriptions &&
                    Object.entries(reportData.prescriptions).map(([key, value], index) => (
                      <li key={index}>
                        <strong>{key}:</strong> {value}
                      </li>
                    ))}
